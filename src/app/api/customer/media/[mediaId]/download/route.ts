...
import { getCustomerSupportAttachmentAccessWorkflow } from '@/modules/support/workflows/get-customer-support-attachment-access.workflow';
...
export async function GET(
  ...
  try {
    return await withRequestContext(request, async () => {
      ...
      if (!session?.workspaceId || !session.customerId) {
      ...
      const attachment = await getCustomerSupportAttachmentAccessWorkflow({
